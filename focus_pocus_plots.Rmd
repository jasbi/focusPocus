...
```{r}
#### NO NEED TO READ THE DATA AGAIN HERE
# Load the dataset
...
## NO NEED TO REORGANIZE ROWS. GENERALLY NOTHING IS ORDERED IN A DATAFRAME
...
Masoud: Probably no need for the chunk below
...
MASOUD: Again no need to load all the libraries here and read the data etc

MASOUD: Make sure the plots have interpretable category names
